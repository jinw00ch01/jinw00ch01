...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=jinw00ch01&label=Profile%20views&color=0e75b6&style=flat" />
  <img src="https://img.shields.io/github/followers/jinw00ch01?label=Followers&style=social" />
  <img src="https://img.shields.io/github/stars/jinw00ch01?label=Stars&style=social" />
</p>
...
#### 🪐 [Isaac Sim 기반 화성 탐사 로버 자원 채취 시스템](https://github.com/sungyu-sung/a-2_isaac)
NVIDIA Isaac Sim의 절차생성 화성 지형에서 6륜 로버가 광물을 인식→접근→채취→복귀(RTB)하는 멀티 로버 시뮬레이션. YOLO 인식 + PPO 강화학습 + 실시간 Web HUD.
`ROS 2 Humble` · `Isaac Sim` · `PPO(강화학습)` · `YOLO` · `Python`

#### 🤖 [ALFRED — 지하철 자율주행 에스코트 로봇](https://github.com/sungyu-sung/rokey_alfred)
지하철역에서 승객을 목적지까지 안내하는 다중 로봇 에스코트 시스템. 시각장애인용 음성 입력, 보행 속도 맞춤 주행, 층간 릴레이 에스코트(엘리베이터 연동), 화재·부상자·위험물 감지 시 관리자 자동 알림.
`ROS 2` · `Nav2 / AMCL` · `rosbridge · WebSocket` · `React 키오스크` · `C++ · Python`

### 🧠 AI · 웹 · 데이터

- 🌏 **[Wind Road — AI 맞춤형 여행 일정 플랫폼](https://github.com/jinw00ch01/TravelAIPlatform)** ([🎬 시연영상](https://youtu.be/RzQJm9uAX0c)) — Gemini AI 기반 맞춤 여행 일정 생성, AWS 서버리스 · Amadeus·Booking·Mapbox 연동
- 🚗 **[BlackBox — 도로교통 규정 RAG 챗봇](https://github.com/jinw00ch01/BlackBox)** — Knowledge Base 검색 근거와 함께 답하는 RAG 챗봇 (FastAPI · AWS Bedrock · React)
- 📈 **[뉴스·SNS 기반 투자 인사이트](https://github.com/jinw00ch01/Stock_Emotional_Analysis)** — 뉴스(FinBERT)·트윗(VADER) 감정분석 × 주가 시계열 기반 간접 투자 인사이트
- 📰 **[Rokey News — 뉴스 감정분석 서비스](https://github.com/jinw00ch01/ROKEY_news)** — NEWSDATA.io 수집 → Gemini 긍·부정 분석 웹, CI/CD·클라우드 배포 (FastAPI · React · PostgreSQL)
...
## 🔥 Activity Graph
[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=jinw00ch01&theme=radical&bg_color=ffffff&color=6439F7&line=bd93f9&point=f8f8f2&area=true&hide_border=true)](#)
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/jinw00ch01/jinw00ch01/output/github-contribution-grid-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/jinw00ch01/jinw00ch01/output/github-contribution-grid-snake.svg" />
    <img alt="github contribution snake animation" src="https://raw.githubusercontent.com/jinw00ch01/jinw00ch01/output/github-contribution-grid-snake.svg" />
  </picture>
</div>
